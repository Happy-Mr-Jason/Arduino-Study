...
char ssid[] = "SJ_WiFi";     // your network SSID (name)
char pwd[] = "73077307";  // your network password
...
void loop()
{
  assertEquals("Firmware version", WiFi.firmwareVersion(), "2.2.1");  //1.5.2 => 2.2.1 SDK Version
